...
export function ActivityCharts({ chartData }: Props) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm h-[440px]">
      <h3 className="text-lg font-semibold text-slate-800 mb-6">Evoluția leadurilor și conversiei</h3>
      <div className="h-[350px] w-full">
        <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
          <ComposedChart
            data={chartData}
            margin={{ top: 16, right: 36, bottom: 48, left: 36 }}
          >
            ...
            <YAxis 
              ...
              tickLine={false}
              tick={{ fill: '#64748b', fontSize: 12 }}
              label={{ value: 'Număr leaduri', angle: -90, position: 'insideLeft', fill: '#3b82f6', fontSize: 12, dy: 40 }}
            />
            <YAxis 
              yAxisId="right" 
              orientation="right" 
              ...
              label={{ value: 'Conversie (%)', angle: 90, position: 'insideRight', fill: '#f97316', fontSize: 12, dy: 40 }}
            />
            <Tooltip
            ...
            <Legend 
              ...
              height={48}
              iconType="circle"
              wrapperStyle={{ fontSize: '12px', color: '#475569', paddingTop: '12px', lineHeight: '18px' }}
            />
